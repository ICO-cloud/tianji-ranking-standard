...
### 6.1.4 Equal Weighting as Baseline | 等权重基线

## 6.2 Weight Validation | 权重验证
### 6.2.1 Sensitivity Analysis Requirements | 敏感性分析要求
### 6.2.2 Stability Testing | 稳定性测试
### 6.2.3 Cross-Validation | 交叉验证

## 6.3 Weight Documentation | 权重文档化
### 6.3.1 Weight Justification | 权重合理性说明
### 6.3.2 Weight Change Protocol | 权重变更协议
### 6.3.3 Stakeholder Review of Weights | 利益相关方权重评审

## 6.4 Anti-Manipulation Provisions | 反操纵条款
### 6.4.1 Weight Bound Constraints | 权重边界约束
### 6.4.2 Outlier Weight Detection | 异常权重检测
