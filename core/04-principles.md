...
### 4.1.4 Outcome Transparency | 结果透明性
### 4.1.5 Methodology Acknowledgment | 方法论确认

## 4.2 ICO-Specific Principles | ICO特定原则
### 4.2.1 Domain Neutrality | 领域中立性
### 4.2.2 Cultural Sensitivity | 文化敏感性
### 4.2.3 Reproducibility | 可复现性
### 4.2.4 Stakeholder Inclusiveness | 利益相关方包容性
### 4.2.5 Anti-Manipulation | 反操纵性

## 4.3 Ethical Boundaries | 伦理边界
### 4.3.1 Non-Discrimination | 非歧视性
### 4.3.2 Privacy Protection | 隐私保护
